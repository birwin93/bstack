...
- [ ] On the operator's go, record the durable objective with this exact text. "<The plan path, the PR ids in order, the verification rule, who merges, the authorization boundary, and the done condition.>"
