...
const LANES = "Ten lanes on `fast-code` at the PR head";
const SUB_BLOCKS = [
	"Depends on.",
	"Files.",
	"Build.",
...
const PROGRAM_MARKERS = ["record the durable objective", "current installed bstack root", /30[- ]minute/, "status message"];
